...
//	switch(typeAnimal){
//	case "dog":
//		var alertDogInput = document.getElementById(tdDog);
//		if(alertDogInput.checked){
//			alertDogInput.innerHTML = "true";
//		}else{
//			alertDogInput.innerHTML = "false";
//		}
//		break;
//	case "cat":
//		var alertCatInput = document.getElementById(tdCat);
//		if(alertCatInput.checked){
//			alertCatInput.innerHTML = "true";
//		}else{
//			alertCatInput.innerHTML = "false";
//		}									
//		break;
//	case "horse":
//		var alertHorseInput = document.getElementById(tdHorse);
//		if(alertHorseInput.checked){
//			alertHorseInput.innerHTML = "true";
//		}else{
//			alertHorseInput.innerHTML = "false";
//		}									
//		break;									
//	}
//	
//	var url = "/status?id="+ id + "&typeAnimal=" + typeAnimal;
//	xhr.open("GET", url, true);
//	xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
//	xhr.send();
//	
